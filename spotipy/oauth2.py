...
from spotipy.util import get_redirect_url
...
class SpotifyOAuth(SpotifyAuthBase):
    ...
    def __init__(
        ...
        super().__init__(requests_session)
        self.app_server_object=app_server
        self.client_id = client_id
        self.client_secret = client_secret
    ...
    def _get_auth_response_interactive(self, open_browser=False):
        ...
        response = get_redirect_url(self.get_authorize_url(), self.app_server_object)#self._get_user_input(prompt)
...
class SpotifyPKCE(SpotifyAuthBase):
    ...
    def _get_auth_response_interactive(self, open_browser=False):
        ...
        response = get_redirect_url(self.get_authorize_url(), self.app_server_object)
